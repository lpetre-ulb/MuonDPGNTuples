...
```
        muNtupleProducer (TDirectory)
                MuDPGTree (TTree)
                        ...
                        mu_propagated_path_length/F (TBranch)
                        mu_propagated_isinsideout (TBranchElement)
                        mu_propagated_isincoming (TBranchElement)
                        ...
                        mu_propagatedSeg_region (TBranchElement)
                        mu_propagatedSeg_layer (TBranchElement)
                        mu_propagatedSeg_chamber (TBranchElement)
                        mu_propagatedSeg_etaP (TBranchElement)
                        ...
                        mu_propagatedSeg_pt (TBranchElement)
                        mu_propagatedSeg_phi (TBranchElement)
                        mu_propagatedSeg_eta (TBranchElement)
                        mu_propagatedSeg_charge (TBranchElement)
                        ...
                        mu_propagatedSegLoc_x (TBranchElement)
                        mu_propagatedSegLoc_y (TBranchElement)
                        mu_propagatedSegLoc_z (TBranchElement)
                        mu_propagatedSegLoc_r (TBranchElement)
                        mu_propagatedSegLoc_phi (TBranchElement)
                        mu_propagatedSegLoc_errX (TBranchElement)
                        mu_propagatedSegLoc_errY (TBranchElement)
                        mu_propagatedSegLoc_dirX (TBranchElement)
                        mu_propagatedSegLoc_dirY (TBranchElement)
                        mu_propagatedSegLoc_dirZ (TBranchElement)
                        ...
                        mu_propagatedSegGlb_x (TBranchElement)
                        mu_propagatedSegGlb_y (TBranchElement)
                        mu_propagatedSegGlb_z (TBranchElement)
                        mu_propagatedSegGlb_r (TBranchElement)
                        mu_propagatedSegGlb_phi (TBranchElement)
                        mu_propagatedSegGlb_errX (TBranchElement)
                        mu_propagatedSegGlb_errY (TBranchElement)
                        mu_propagatedSegGlb_errR (TBranchElement)
                        mu_propagatedSegGlb_errPhi (TBranchElement)
